...
function gravarPontuacao() {
    ...
    //         <tbody>
    //           <tr>
    //             <th scope="row">1</th><th>${rankingNickJSON[1]}</th><th>${rankingPontoJSON.ponto1}</th>
    //             <td>AAA</td>
    //             <td>0</td>
    //             <td>0</td>
    //           </tr>
    //           <tr>
    //             <th scope="row">2</th><th>${rankingNickJSON[2]}</th><th>${rankingPontoJSON.ponto2}</th>
    //             <td>BBB</td>
    //             <td>0</td>
    //             <td>0</td>
    //           </tr>
    //           <tr>
    //             <th scope="row">3</th><th>${rankingNickJSON[3]}</th><th>${rankingPontoJSON.ponto3}</th>
    //             <td>CCC</td>
    //             <td>0</td>
    //             <td>0</td>
    //           </tr>
